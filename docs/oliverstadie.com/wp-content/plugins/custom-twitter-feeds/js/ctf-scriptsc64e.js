  ...
  (function ($) {
    ...
    function ctfScripts($ctf) {
      ...
      $ctf.find(".ctf-item.ctf-new").each(function () {
        ...
        if (
          $ctf.attr("data-ctfdisablelinks") != "true" &&
          typeof ctfTextStr !== "undefined"
        ) {
      ...
      $ctf
        .find(
          ".ctf-author-name, .ctf-tweet-date, .ctf-author-screenname, .ctf-twitterlink, .ctf-author-box-link, .ctf-retweet-text, .ctf-quoted-tweet",
        )
        .css("color", $ctf.find(".ctf-tweet-text").css("color"));
      ...
      $ctf
        .find(".ctf-twitterlink")
        .css("line-height", $ctfIconFirst.height() + "px");

      //Adjust icon number font size to be slightly smaller than the icon size
      if ($ctfIconFirst.length) {
        var ctfIconSize = parseInt(
          $ctfIconFirst.css("font-size").replace("px", ""),
        );
      ...
      $ctf.find(".ctf-header .ctf-header-link").hover(
        function () {
    ...
    function ctfLoadTweets(
      ...
      $ctfMore
        .find(".ctf-loader")
        .css("background-color", $ctfMore.css("color"));
